...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        private void Move()
        {
            // Always run forward automatically
            float targetSpeed = SprintSpeed; // Always running speed
            ...
            // Always move forward on the Z-axis, add horizontal input if any
            Vector3 moveDirection = transform.forward * _speed +
                                    new Vector3(_input.move.x, 0.0f, 0.0f).normalized * _speed;
